...
public class TemplateServiceImpl implements TemplateService {
    ...
    public void delete(Integer id) {
        ...
        //删除模板的所有信息
        Example examplePara = new Example(Para.class);
        Example.Criteria criteriaPara = examplePara.createCriteria();
        criteriaPara.andEqualTo("templateId", id);
        paraMapper.deleteByExample(examplePara);

        Example exampleSpec = new Example(Spec.class);
        Example.Criteria criteriaSpec = exampleSpec.createCriteria();
        criteriaSpec.andEqualTo("templateId", id);
        specMapper.deleteByExample(exampleSpec);
    }
